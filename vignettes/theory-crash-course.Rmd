...
3. The environmental health (EH)-specific extensions in `pcpr`
4. Convex and non-convex PCP
5. PCP parameters `lambda`, `mu`, and `eta`
6. Tuning parameters with `grid_search_cv()`

We recommend researchers skim this crash course before reading the two code-heavy vignettes:
...
[Gibson et al. (2022)](https://doi.org/10.1289/EHP10479) demonstrates that in experimental
...
Multipliers (ADMM) algorithm [Boyd et al. (2011)](http://dx.doi.org/10.1561/2200000016),
...
Candès et al. (2011) obtained the guarantee for $\lambda$, while Zhang et al. (2021) obtained the result for $\mu$.
