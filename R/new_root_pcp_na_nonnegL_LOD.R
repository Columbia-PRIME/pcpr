...
#'
#' @export
#' may want to go back and put conditional statements on all L3 lines ...
new_root_pcp_na_nonnegL_lod <- function(D, lambda, mu, LOD = 0, useNonnegative = T, verbose = FALSE) {
...
# changed this to unify both nonnegative and arb signs
if (useNonnegative) {
  L3 = pmax(L1+Y4/rho,0)
} else {
  L3 = L1+Y4/rho
