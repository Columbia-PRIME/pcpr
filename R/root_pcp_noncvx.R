#' Squareroot PCP function with non-convex replacement for nuclear norm
#'
...
#'
#' 1_{rank(L) <= r} + lambda * ||S1||_1 + mu * ||Z||_F \cr \cr
...
#'
#' @export
root_pcp_noncvx <- function(D, lambda, mu, r, verbose=FALSE) {
  ...
  for (i in 1:MAX_ITER) {
    ...
    ## This is the only change to make it nonconvex
