...
Extensive documentation is available on our pkgdown [website](https://columbia-prime.github.io/pcpr/) and offline within R.
...
Have a bug to report or quesion to ask? [Open an issue on our GitHub](https://github.com/Columbia-PRIME/pcpr/issues).
...
![A PCP mixtures model visualized](man/figures/README-pcp-model-1.jpeg)
...
Please also cite [Gibson et al. (2022)](https://doi.org/10.1289/EHP10479).

This work was supported by NIEHS PRIME R01 ES028805.

Special thanks to [Sophie Calhoun](https://www.sophiecalhoun.com/) for designing `pcpr`'s logo!
