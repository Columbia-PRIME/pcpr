...
Let's simulate a random 20% of the values as missing (`NA`) with the `corrupt_mat_randomly()` function:
...
Now let's look at PCP's estimate of the sparse matrix and fix any values that are "practically" zero
